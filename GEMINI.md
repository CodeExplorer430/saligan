...
`AGENTS.md` is canonical. Read it first and follow its required reading order.

- Inspect repository context, status, diffs, specifications, and nearby code before editing.
